...
controls = ["TP53_Ctrl", "test_control"]
...
include: "rules/freec-alternative.smk"
...
rule all:
	input:
		...
		## CNVs control-FREEC
		['%s/%s/freec_AltCtrl/freec_CNVs.p.value.txt' % (derived,t) for t in tumors],
